...
function Hero() {
  return (
    <div
      className="w-full h-screen pt-[35px] md:pt-[75px] lg:pt-[150px] pr-[1px] md:pr-[97px] pb-[20px] pl-[21px] md:pl-[97px] md:flex justify-between items-center bg-cover bg-center gap-[20px]"
      style={{ backgroundImage: `url(${backgroundImage})` }}
    >
      <div className="flex-wrap flex pr-5 md:pr-0 flex-col w-full md:w-[56%]">
        <h2 className="text-gray-800 text-2xl md:text-3xl lg:text-6xl font-medium md:leading-[60px] tracking-tighter">
        Managed investing made to grow your wealth
        </h2>
        <p className="hero-subtitle text-gray-500 font-inter text-xs md:text-base font-normal leading-6 mt-[10px]">
        ...
        <div className="hero-button md:flex items-center gap-5 mt-6">
          <button className="w-full md:w-max font-Inter text-[14px] font-semibold leading-7 tracking-widest px-[24px] py-[7px] rounded-full bg-blue-700 shadow-md flex justify-center items-center text-white">
            Get started
          </button>
          <div className="Ai-assistant  cursor-pointer flex gap-2 text-blue-700 font-inter text-sm font-semibold  items-center mt-5 md:mt-0">
            <span>
              <svg
        ...
        <div className="user-review flex items-center mt-8 gap-5">
          <div className="avatar_group">
            <img src={avatargroup} alt="avatargroup" />
          </div>
          <div className="reviews ">
            <div className="star-row flex  items-center gap-[5px]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
              ...
              <span className="star-number text-gray-700 text-xs md:text-[1rem] leading-6 font-semibold ml-1">
                5.0
              </span>
            </div>
            <div className="review-content text-gray-600 text-xs md:text-[1rem] font-medium leading-6">
              from 3,000+ reviews
            </div>
          </div>
        </div>
      </div>
      <div className=" border relative border-blue-200 bg-blue-50 rounded-[16px] shadow-3xl mr-8 flex md:px-8 justify-center items-center md:w-[54%] h-[79%] gap-[10px] mt-5 mb-32">
        ...
        <div className="absolute bottom-[85px] md:bottom-[52px] py-1 px-2 w-1/2 bg-[#fff] opacity-55 rounded-md text-xs md:right-8 right-0">
          <div className="flex text-black justify-between items-center">
            ...
            <small>now</small>
              ...
              <p className="text-black font-bold z-50">We automatically invested your $500 deposit.</p>
            </div>
      </div>
    </div>
  );
